...
export class BuildingEntity extends BaseEntityWithIdAbstract {
  ...
  @Column({ nullable: true })
  @Field(() => String, {
    description: "photos of the building",
    nullable: true,
  })
  photo: string;
  ...
  description?: string;
  @ManyToMany(() => ParkingGuardEntity, (g) => g.guardBuildings, {
    eager: true,
    nullable: true,
  })
